  ...
  return (
    <section className="flex flex-col h-screen lg:justify-end font-poppins">
      <div className="w-full bg-blue-900 pt-11 dark:bg-gray-900 ">
        <div className="justify-center flex-1 max-w-7xl px-4 py-4 mx-auto lg:py-0">
          ...
          <div className="flex flex-wrap py-10 -mx-3">
            <div className="w-full px-4 mb-11 md:w-1/2 lg:w-5/12 lg:mb-0">
              ...
              <p className="text-base font-normal leading-6 text-gray-300 lg:w-84 dark:text-gray-400">
            ...
            <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-5/12">
              ...
              <p className="flex items-center mb-4">
                ...
                RZ - 1124/1, Ground Floor, Street No 14/5, Sadh Nagar, New Delhi
                </span>
              </p>
              <p className="flex items-center mb-4 ">
                <svg
        ...
        <div className="py-5 text-center text-gray-200 bg-blue-800  dark:text-gray-400">
