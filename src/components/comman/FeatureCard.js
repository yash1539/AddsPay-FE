   ...
   <section className="flex items-center justify-center bg-gray-100 ">
        <div className="px-4 py-20 mx-auto max-w-7xl">
            <div className="max-w-xl mx-auto">
                <h1 className="mb-4 text-3xl font-bold text-center dark:text-white"> Our Features </h1>
            ...
            <div className="grid grid-cols-1 gap-x-4 gap-y-6 lg:gap-x-8 lg:gap-y-8 md:grid-cols-2 lg:grid-cols-3">
                ...
                <div
                    className="w-full p-8 mb-5 text-center transition-all bg-white rounded shadow dark:bg-gray-100 hover:shadow-lg">
                    <div className="inline-block p-4 mb-6 -mt-16 bg-blue-400 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                            className="text-white" viewBox="0 0 16 16">
                            <path fillRule="evenodd"
