        ...
        <div className="grid lg:grid-cols-[70%,1fr]  gap-6  pt-9 pb-7">
            <div>
                <div className="p-4 bg-white ">
                    ...
                    <h2 className="text-2xl font-semibold mb-7 font-poppins ">13 ways budget
                    ...
                    <div className="pt-5 pb-5 font-poppins ">
                        ...
                        <blockquote
                            className="p-6 my-4 italic bg-gray-100 border-l-4 border-blue-500 dark:border-blue-400  ">
                            Lorem
                ...
                <div className="px-4">
                    <h2 className="mt-4 text-2xl font-semibold text-gray-900  font-poppins">Products
                    </h2>
                ...
                <div class="mt-56 bg-white rounded shadow dark:bg-gray-700">
                    <div class="relative z-20 p-6 group">
                        <div class="relative block h-64 mb-4 -mt-56 overflow-hidden rounded -top-full ">
                            <img class="object-cover w-full h-full transition-all group-hover:scale-110" src="https://i.postimg.cc/x8LtrkfV/kenny-eliason-HIz-Gn9-FZDFU-unsplash.jpg" alt="" />
            ...
            <div>
                <div className="p-4 mb-4 bg-white ">
                    <div>
                        <h2
                            className="text-xl font-semibold leading-5 tracking-tight text-gray-900  lg:text-lg">
                            Popular Posts</h2>
                        ...
                        <div className="gap-4 pb-3 my-4 border-b dark:border-gray-500 lg:flex ">
                            <div>
                                ...
                                <h2
                                    className="text-lg font-semibold leading-5 tracking-tight text-gray-900  lg:text-xl ">
                ...
                <div className="p-6 mb-4 bg-white border rounded shadow  dark:border-gray-900">
                    <h2
                        className="py-2 my-2 text-xl font-semibold leading-5 tracking-tight text-gray-900 font-montserrat lg:text-3xl  lg:mt-3 ">
                    ...
                    <p className="mt-2 text-gray-700 ">Join our email list to get new updates and
                        inspirations
                        for
                        free.
                    </p>
                ...
                <div>
                    <div className="p-4 bg-white ">
                        <h2
                            className="py-2 text-xl font-semibold leading-5 tracking-tight text-gray-900  font-montserrat lg:text-lg ">
                            Follow Us</h2>
